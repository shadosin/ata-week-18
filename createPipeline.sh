...
echo "Project name: $WEEK_18_PROJECT_NAME"
echo "Github UserName: $GITHUB_USERNAME"
echo "Repo path: $WEEK_18_REPO_NAME"
echo "Branch: $branch"

aws cloudformation create-stack --stack-name $WEEK_18_PROJECT_NAME-$GITHUB_USERNAME --template-url https://ata-deployment-scripts.s3.us-east-1.amazonaws.com/CICDPipeline-Unit4.yml --parameters ParameterKey=ProjectName,ParameterValue=$WEEK_18_PROJECT_NAME ParameterKey=GithubUserName,ParameterValue=$GITHUB_USERNAME ParameterKey=Repo,ParameterValue=$WEEK_18_REPO_NAME ParameterKey=Branch,ParameterValue=$branch ParameterKey=GithubToken,ParameterValue=$GITHUB_TOKEN --capabilities CAPABILITY_IAM
